...
public class ListingTask extends BaseTask {
    ...
    /*
     *  Ideally this should be an Async process because if csv contains huge number of records it could take very long
     ...
     *
     * we could do this process in batches if the number of listing is huge.
     */

    //this method returns the total inserted listings
    ...
    /*
     *  here I have used JPA saveAll(to save times) which is very slow because it fires separate queries
     *  the best approach is to user 'insert ignore into listings ..values(),(),(),(),()'. insert all listings in single query
     ...
     */
    private void saveListings(List<ListingEntity> entities) {
